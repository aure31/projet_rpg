class Player():
    def __init__(self,username,coo=["centre map y","centre map x"],hp=50,money=0,inventory={'sword':None,'shield':None}):
    ...
    def get_item(self,item): # get an item or upgrade it
